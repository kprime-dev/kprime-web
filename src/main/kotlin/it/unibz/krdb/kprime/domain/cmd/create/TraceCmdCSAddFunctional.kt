...
object TraceCmdCSAddFunctional : it.unibz.krdb.kprime.domain.cmd.TraceCmd {
    override fun getCmdName(): String {
        return "add-cs-functional"
    }

    override fun getCmdDescription(): String {
        return "Add one functional constraint to current changeset."
    }
    ...
    override fun execute(context: CmdContext, command: String): TraceCmdResult {
        ...
        val constraints = SchemaCmdParser.parseFunctionals(index,tableName,constrainSpec)
        changeSet plus constraints.first()
        return TraceCmdResult() message "Add functional to changeset executed."
    }
