...
object TraceCmdJsonToSql : TraceCmd {
    override fun getCmdName(): String {
        return "json-create-sql"
    }

    override fun getCmdDescription(): String {
        return "Creates a physical database set of tables starting from data file in JSON format."
    }
    ...
    override fun executeMap(context: CmdContext, args: Map<String, Any>): TraceCmdResult {
        ...
        runCatching {
        context.pool.dataService.createSqlFromFileJson(
